...
---
## JVM 메모리 구조와 자바가 실행될 때 JVM에서 일어나는 일을 알아보자

- 출처: [https://jeong-pro.tistory.com/148](https://jeong-pro.tistory.com/148) (기본기를 쌓는 정아마추어 코딩블로그)
- 추가 참고 자료: [https://sehun-kim.github.io/sehun/JVM/](https://sehun-kim.github.io/sehun/JVM/)
